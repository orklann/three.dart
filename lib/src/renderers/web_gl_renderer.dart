...
class WebGLRenderer implements Renderer {
  ...
  WebGLRenderer(
    ...
    this.devicePixelRatio = (devicePixelRatio != null)
        ? devicePixelRatio
  ...
  updateObject(Object3D object) {
    ...
    bool hasAttributes = ((material is ShaderMaterial) &&
        (material as ShaderMaterial).attributes != null);
      ...
      if (texture is DataTexture) {
        ...
        if (mipmaps.length > 0 && isImagePowerOfTwo) {
          for (var i = 0, il = mipmaps.length; i < il; i++) {
            mipmap = mipmaps[i];
            _gl.texImage2DTyped(gl.TEXTURE_2D, i, glFormat, mipmap.width,
                mipmap.height, 0, glFormat, glType, mipmap.data);
          }

          texture.generateMipmaps = false;
        } else {
          _gl.texImage2DTyped(gl.TEXTURE_2D, 0, glFormat, image.width,
